...
/*
 * 1. Element type - When the elements are not of a trivial type, deque is not much less efficient than vector.
 *                   Copying objects in vector is expensive for non-trivial type.
 */
...
/*
 * 5. Vector's unique feature: portal to C - not for vector<bool> though
 */
  vector<int> vec = {2,3,4,5}; 
